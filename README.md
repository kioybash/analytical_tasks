...
Колонки с показателями назовём соответственно **new_users, new_couriers, total_users, total_couriers**. Колонку с датами назовите **date**. 
...
### **🔷Задача 3:** 
Теперь давайте посмотрим на нашу аудиторию немного под другим углом — посчитаем не просто всех пользователей, а именно ту часть, которая оформляет и оплачивает заказы в нашем сервисе. 
...
Колонки с показателями назовём соответственно **single_order_users_share, several_orders_users_share.** Колонку с датами назовите **date**. 
...
Колонки с показателями назовём соответственно **users_per_courier** и **orders_per_courier**. Колонку с датами назовём **date**. 
...
Колонку с показателем назовём **minutes_to_deliver**. Колонку с датами назовём **date**.
...
Колонки с показателями назовём соответственно **successful_orders, canceled_orders, cancel_rate**. Колонку с часом оформления заказа назовём **hour**. 
